...
| 장전 분석 | 15:40 | 일봉 로드 → Claude Vision 차트 분석 → pending 신호 DB 저장 |
| 재분석 | 16:00~익일 00:00 (매시) | pending 3개 미만이면 자동 재분석 |
...
- **재분석 조건**: 16:00~익일 00:00 사이 매시 정각, pending 신호 3개 미만이면 재분석 실행
