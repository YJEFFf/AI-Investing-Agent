...
스윙 매수 기준 (복수 조건 충족 시 buy):
- EMA20이 EMA60 위에서 우상향 중이거나 골든크로스 임박
- 볼린저밴드 하단 터치 후 반등 징조 또는 중단선 돌파
- RSI 30~55 구간에서 상향 전환 (과매도 해소)
- 거래량 동반 양봉 (평균 대비 1.5x 이상)
- 캔들 패턴: 망치형, 역망치형, 장악형 양봉

스윙 스킵 기준:
- EMA 하락 배열 유지 or 볼린저밴드 상단 돌파 과매수
- RSI 70 이상 or 하락 다이버전스
- 거래량 없는 음봉 연속 or 지지선 이탈

target_pct: 예상 목표 수익률 (5~12% 권장)
stop_pct: 손절 비율 (3~6% 권장)
confidence 기준:
- 0.75 이상: 다중 신호 일치 → 진입
- 0.60~0.74: 보조 신호 1~2개 → 소량 진입 검토
- 0.60 미만: 불확실 → skip
